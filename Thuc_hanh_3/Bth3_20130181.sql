...
SELECT c.SoHD,h.NgaylapHD,n.TenNGK, SUM(SLKHMua*DGBan) FROM dbo.HOADON h JOIN dbo.CT_HOADON c JOIN dbo.NGK n ON n.MaNGK = c.MaNGK ON c.SoHD = h.SoHD GROUP BY c.SoHD,h.NgaylapHD, n.TenNGK ORDER BY h.NgaylapHD ASC, SUM(SLKHMua*DGBan) DESC
